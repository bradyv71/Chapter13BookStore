...
namespace Bookstore.Controllers
{
    public class BookController : Controller
    {
        ...
        {
            BooksGridBuilder booksGridBuilder = new BooksGridBuilder(HttpContext.Session);
            booksGridBuilder.CurrentRoute.PageSize = pagesize;
            booksGridBuilder.SaveRouteSegments();
            return RedirectToAction("List", booksGridBuilder.CurrentRoute);
